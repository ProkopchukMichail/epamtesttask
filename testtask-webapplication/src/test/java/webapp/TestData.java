...
public class TestData {
    public static final Department ADMINISTRATION=new Department(1,"Administration");
    public static final Department IT=new Department(2,"IT");
    public static final Department FINANCE=new Department(3,"Finance");
    public static final Department HR_DEPARTMENT =new Department(4,"HR_DEPARTMENT");
